...
ENV SQL_PARAMS_EXEC "sql-params-exec"
...
ENV ORACLE_INIT_SQL_PARAMS_IGRNORE_ERROS "false"
ENV ORACLE_INIT_SQL_PARAMS "--ignore-erros \$ORACLE_INIT_SQL_PARAMS_IGRNORE_ERROS"
